...
def acessar_site(bot):
    ...
    bot.print_pdf('C:\\Users\\noturno\\prova_botcity\\bot_eleitor\\pdf\\SiteProduto.pdf')
...
def main():
    ...
    arq_excel = 'C:\\Users\\noturno\\prova_botcity\\bot_eleitor\\planilha\\RelacaoProduto.xlsx'
    sheet = 'produto'  
    ...
    lista_pdf = []
    lista_pdf.append('C:\\Users\\noturno\\prova_botcity\\bot_eleitor\\pdf\\ListaProduto.pdf')
    lista_pdf.append('C:\\Users\\noturno\\prova_botcity\\bot_eleitor\\pdf\\SiteProduto.pdf')
    pdf.merge_pdfs(lista_pdf,'C:\\Users\\noturno\\prova_botcity\\bot_eleitor\\pdf\\Produtos.pdf')
    
    print('Enviando E-mail para a lista de usuario com arquivo Produtos.pdf em anexo.')
    arq_anexo = 'C:\\Users\\noturno\\gabarito_ambiente\\botproduto\\pdf\\Produtos.pdf'
